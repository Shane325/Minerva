...
var snapper = new Snap({
  ...
  addEvent = function (b, c, d) {
    return b.addEventListener ? b.addEventListener(c, d, !1) : b.attachEvent ? b.attachEvent("on" + c, d) : void 0
  };
addEvent(document.getElementById("open-left"), "click", function () {
  snapper.open("left")
}), jQuery(document).ready(function (a) {
  var b = a(".mini-cart");
  if (b.on("click", function (b) {
      a(this).addClass("open")
    }), a(document).on("click", function (c) {
      0 == a(c.target).closest(b).length && b.removeClass("open")
    }), a(".search-btn").on("click", function () {
      a(".top-search").slideToggle(), a(".top-search input").focus()
      ...
      d.on("click", "a", function () {
        ...
        return a(".filter-wrapper").find(".filterbutton").removeClass("selected"), a(".current", d).removeClass("current"), a(this).addClass("current"), c.isotope({
          filter: b
        }), !1
      ...
      }).resize(), d.find(".current").trigger("click")
      ...
      a(window).scrollTop() > 100 ? a(".scrollup").addClass("show") : a(".scrollup").removeClass("show")
    }), a(".scrollup").on("click", function (b) {
      a("html, body").animate({
        scrollTop: 0
      }, 600), b.preventDefault()
    ...
    }), a(".slider-nivo").length > 0 && a(".nivoSlider").nivoSlider({
      effect: "random",
      slices: 15,
      boxCols: 8,
      boxRows: 4,
      ...
      prevText: "Prev",
      nextText: "Next"
    }), a("#map-canvas").length > 0) {
    var c = a("#map-canvas");
    if (c.length) {
      var d = c.attr("data-address"),
        e = c.attr("data-height"),
        f = c.attr("data-width"),
        g = c.attr("data-zoom_enable"),
        h = c.attr("data-zoom");
      c.gmap3({
        action: "init",
        marker: {
          ...
          events: {
            click: function (b, c) {
              var d = a(this).gmap3("get");
              infowindow = a(this).gmap3({
                get: {
                  name: "infowindow"
                }
              }), infowindow ? (infowindow.open(d, b), infowindow.setContent("1485 Bayshore Boulevard, San Francisco, CA")) : a(this).gmap3({
                infowindow: {
                  anchor: b,
                  options: {
                    content: "1485 Bayshore Boulevard, San Francisco, CA"
                  }
                }
              })
            }
  ...
  a("#rev_slider_1").length > 0 && RevSlider1_Init(), a("#rev_slider_2").length > 0 && RevSlider2_Init(), a("#rev_slider_3").length > 0 && RevSlider3_Init(), a("#rev_slider_4").length > 0 && RevSlider4_Init()
